...
function PanelSection(props) {
  return (
    <section className="panelSection filterMenuSection">
      <span className="panelLabel">{props.label}</span>
      <div className={props.three ? "segmentedPanelGrid three" : "segmentedPanelGrid"}>
        {props.children}
      </div>
    </section>
  );
...
export function FilterPanel(props) {
  ...
  return (
    <div className="floatingPanel filterPopover filterMenuPanel refinedFilterMenu polishedMenuPanel" role="menu" aria-label="FILTER">
      <PanelSection label="SORT" three>
      ...
      <PanelSection label="SOURCE" three>
